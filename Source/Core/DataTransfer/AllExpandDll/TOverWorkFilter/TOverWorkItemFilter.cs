...
namespace TOverWorkFilter
{
    public class TOverWorkItemFilter : TableFilterTemplate
    {
        ...
        {
            return new TOverWorkItemFilter();
        }
        ...
        protected override Dictionary<string, string> DefineProtectedTableFkColumnName()
        {
            ...
            retVal.Add(_ProtectedTable, "OverWorkItemID");
            return retVal;
        }
