...
namespace TOverWorkFilter
{
    public class TOverWorkFilter : TableFilterTemplate
    {
        private const string _ProtectedTable = "TOverWorkItem";
        private TOverWorkItemFilter _OutApplicationItemFilter = new TOverWorkItemFilter();
        ...
        protected override Dictionary<string, string> DefineProtectedTableFkColumnName()
        {
            ...
            retVal.Add(_ProtectedTable, "OverWorkID");
            return retVal;
        }
