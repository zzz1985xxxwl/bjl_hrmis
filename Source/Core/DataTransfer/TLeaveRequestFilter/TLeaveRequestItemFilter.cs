...
namespace TLeaveRequestFilter
{
    public class TLeaveRequestItemFilter : TableFilterTemplate
    {
        ...
        {
            return new TLeaveRequestItemFilter();
        }
        ...
        protected override Dictionary<string, string> DefineProtectedTableFkColumnName()
        {
            ...
            retVal.Add(_ProtectedTable,"LeaveRequestItemId");
            return retVal;
        }
