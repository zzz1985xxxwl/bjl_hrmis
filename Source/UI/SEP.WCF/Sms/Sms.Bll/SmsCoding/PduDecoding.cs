...
namespace Sms.Bll.SmsCoding
{
    ...
    public class PduDecoding
    {
        ...
        public static bool DecodingMsg(string s, out string senderNumber, out string content, out DateTime sendTime)
        {
            senderNumber = null;
            content = null;
        ...
        public static string EncodingBit7(string s)
        {
            ...
            return (sb.Length/2).ToString("X2") + sb;
        }
