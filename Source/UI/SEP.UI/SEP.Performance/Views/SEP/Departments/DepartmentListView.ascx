    ...
    　　　　　　　　　　　　<asp:Button ID="btnHiddenPostButton" CommandArgument='<%# Eval("Id") %>' CommandName="HiddenPostButtonCommand" runat="server" Text="" style=" display:none;"/>
                        ...
                        <asp:TemplateField HeaderText="部 门">
                            <ItemTemplate> 
                                ...
                                <%#Eval("Name")%>(<%#Eval("CountEmployee")%>人)
            ...
            <tr>
                <td>
                    <div  id="<%# "Item"+Eval("Id")%>" style="display:none; z-index:10; position:relative;">
                        ...
                        <asp:TemplateField>
                            <ItemTemplate> 
                                <asp:LinkButton ID="btnAdd" Text="添加子部门" OnCommand="btnAdd_Click" runat="server"  CommandArgument='<%# Eval("Id")%>'/>
                            </ItemTemplate>
                                <ItemStyle Width="10%"/>
                        </asp:TemplateField>
                        <asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate> 
                                <asp:LinkButton ID="btnDelete" Text="删除" OnCommand="btnDelete_Click"  runat="server" CommandArgument='<%# Eval("Id")%>' />
                            </ItemTemplate>
                                <ItemStyle Width="5%"/>
                        </asp:TemplateField>
                    </Columns>                
