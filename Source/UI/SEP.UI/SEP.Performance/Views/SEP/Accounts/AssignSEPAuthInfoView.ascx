<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AssignSEPAuthInfoView.ascx.cs" Inherits="SEP.Performance.Views.SEP.Accounts.AssignSEPAuthInfoView" %>
...
<%@ Register Src="AssignAuthView.ascx" TagName="AssignAuthView" TagPrefix="uc2" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <!--大界面-->
        <uc2:AssignAuthView ID="AssignAuthView1" runat="server"></uc2:AssignAuthView>
