...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReimburseHistoryListView.ascx.cs" Inherits="SEP.Performance.Views.HRMIS.Reimburse.ReimburseHistoryListView" %>
<asp:HiddenField ID="hfCount" runat="server" Value="0" />
<div id="tbReimburse" runat="server">
<div class="leftitbor2">
<asp:Label ID="lbOperationType" runat="server" CssClass="fontwhite14b">报销单历史</asp:Label>
</div>
