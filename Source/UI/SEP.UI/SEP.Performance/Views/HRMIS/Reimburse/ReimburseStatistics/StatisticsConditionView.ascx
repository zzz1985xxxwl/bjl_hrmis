<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StatisticsConditionView.ascx.cs" 
Inherits="SEP.Performance.Views.HRMIS.Reimburse.ReimburseStatistics.StatisticsConditionView" %>
        ...
        <table width="100%" class="linetable" cellpadding="0" cellspacing="10" style="background-color:White;border-collapse:separate;">
          ...
          <tr>
              <td colspan="2" style="text-align:center">
                ...
                <asp:Button ID="btnExport" runat="server" Text="导　出" CssClass="inputbt" OnClientClick="location.href='ReimburseStatisticsExportPage.aspx?type=department';return false;"/>
              </td>
          </tr>
        </table>
    </td>
