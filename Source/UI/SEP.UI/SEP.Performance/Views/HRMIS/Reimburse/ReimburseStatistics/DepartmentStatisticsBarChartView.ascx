<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DepartmentStatisticsBarChartView.ascx.cs" Inherits="SEP.Performance.Views.HRMIS.Reimburse.ReimburseStatistics.DepartmentStatisticsBarChartView" %>
