<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ComeAndLeaveBarChartView.ascx.cs" Inherits="SEP.Performance.Views.EmployeeStatistics.ComeAndLeaveBarChartView" %>
