<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkAgePieChartView.ascx.cs" Inherits="SEP.Performance.Views.EmployeeStatistics.WorkAgePieChartView" %>
<%@ Register Assembly="ZedGraph.Web" Namespace="ZedGraph.Web" TagPrefix="cc1" %>
<cc1:ZedGraphWeb ID="zgwWorkAgePie" runat="server" RenderedImagePath="~/pages/image/imageZedGraph/" Height="250" Width="370">
