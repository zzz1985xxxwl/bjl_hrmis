<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GenderPieChartView.ascx.cs" Inherits="SEP.Performance.Views.EmployeeStatistics.GenderPieChartView" %>
<%@ Register Assembly="ZedGraph.Web" Namespace="ZedGraph.Web" TagPrefix="cc1" %>
<cc1:ZedGraphWeb ID="zgwGenderChart" runat="server" RenderedImagePath="~/pages/image/imageZedGraph/" Height="250" Width="370">
