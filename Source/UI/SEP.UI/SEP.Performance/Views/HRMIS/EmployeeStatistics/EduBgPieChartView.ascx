<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EduBgPieChartView.ascx.cs" Inherits="SEP.Performance.Views.EmployeeStatistics.EduBgPieChartView" %>
<%@ Register Assembly="ZedGraph.Web" Namespace="ZedGraph.Web" TagPrefix="cc1" %>
<cc1:ZedGraphWeb ID="zgwEduBgPie" runat="server" RenderedImagePath="~/pages/image/imageZedGraph/" Height="250" Width="370">
