<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkTypePieChartView.ascx.cs" Inherits="SEP.Performance.Views.EmployeeStatistics.WorkTypePieChartView" %>
<%@ Register Assembly="ZedGraph.Web" Namespace="ZedGraph.Web" TagPrefix="cc1" %>
<cc1:ZedGraphWeb ID="zgwWorkTypePie" runat="server" RenderedImagePath="~/pages/image/imageZedGraph/" Height="250" Width="370">
