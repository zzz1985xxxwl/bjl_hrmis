<%@ Control Language="C#" AutoEventWireup="true" Codebehind="OperationView.ascx.cs"
    Inherits="SEP.Performance.Views.HRMIS.OutApplications.OperationView" %>
<div id="tbResultMessage" runat="server" class="leftitbor">
    <span class="fontred">
        <asp:Label ID="lbResultMessage" runat="server"></asp:Label></span>
</div>
<div class="leftitbor2" width="98%">
    ...
    <table width="100%" border="0">
        <tr style="display: none;">
            ...
            <td width="30%" align="left">
                <asp:TextBox runat="server" ID="tbID" CssClass="input1" ReadOnly="True"></asp:TextBox>
            </td>
            <td width="12%" align="left">
                编号</td>
            <td align="left">
                <asp:TextBox ID="tbOutApplicationID" runat="server" CssClass="input1" ReadOnly="True"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right">
