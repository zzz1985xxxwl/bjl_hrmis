<%@ Control Language="C#" AutoEventWireup="true" Codebehind="OutApplicationEditView.ascx.cs"
    Inherits="SEP.Performance.Views.HRMIS.OutApplications.OutApplicationEditView" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
            ...
            <table width="100%" border="0">
                <tr>
                 ...
                 <tr>
                    ...
                    <td align="left">
                        外出类型</td>
                    <td align="left">
                        <asp:DropDownList ID="ddlOutType" AutoPostBack="true" OnSelectedIndexChanged="ddlOutType_SelectedIndexChanged" CssClass="outType" runat="server">
                        </asp:DropDownList>
                      </td>
                    <td align="left">
                        外出时间</td>
                    <td align="left">
                        <strong>
                            <asp:Label ID="lbCostTime" runat="server"></asp:Label></strong></td>
                </tr>
                <tr>
                    <td align="right">
                    </td>
                    <td align="left">
                        外出地点&nbsp;<span class="redstar">*</span></td>
                    <td align="left">
                        <asp:TextBox ID="txtOutLoacation" CssClass="input1" runat="server"></asp:TextBox><asp:Label ID="lbOutLocationMessage"
                            runat="server" CssClass="psword_f"></asp:Label></td>
                    <td align="left">
                       </td>
                    <td align="left">
                       </td>
                ...
                <tr>
                    ...
                    <td align="left" colspan="3" valign="top">
                        <asp:TextBox runat="server" ID="txtMailCC" CssClass="input1" Width="85%" onfocus="btnChooseMailCCClick();"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td align="left" valign="top">
                        外出理由&nbsp;<span class="redstar">*</span></td>
                    <td align="left" colspan="3" valign="top">
                ...
                <tr>
                    ...
                    <td align="left" colspan="6" valign="top">
                        <asp:GridView GridLines="None" Width="100%" ID="gvOutApplication" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="外出小时">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtCostTime" Text='<%# Eval("CostTime").ToString()%>' runat="server"
                                            Enabled="false" CssClass="input1 answer" Style="width: 55px" Rows="1"></asp:TextBox>
                                    </ItemTemplate>
                                    <ItemStyle Width="6%"/>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="状态">
                                 ...
                                 <asp:TemplateField HeaderText="调休" Visible="false">
                                        <ItemTemplate>
                                             <%# Eval("Adjust").ToString()=="True"?"是":"否"%>
                                        </ItemTemplate>
                                        <ItemStyle Width="5%" />
                                      </asp:TemplateField>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbAddItem" Text="<img src=../../../Pages/image/file_new.gif border=0>"
                                            runat="server" OnCommand="lbAddItem_Command" />
                                    </ItemTemplate>
                                    <ItemStyle Width="4%" HorizontalAlign="Left"  />
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbDeleteItem" Text="<img src=../../../Pages/image/file_cancel.gif border=0>"
                                            runat="server" OnCommand="lbDeleteItem_Command" />
                                    </ItemTemplate>
                                    <ItemStyle Width="4%" HorizontalAlign="Left"  />
                                </asp:TemplateField>
                            </Columns>
        ...
        <div class="tablebt">
            <asp:Button ID="BtnOK" OnClick="BtnOK_Click" Text="暂  存" OnClientClick="return judgeTime();"
                runat="server" class="inputbt" />
            <asp:Button ID="BtnSubmit" OnClick="BtnSubmit_Click" Text="提  交" runat="server" OnClientClick="return judgeTime();"
                class="inputbt" />
        </div>
...
{
$("#cphCenter_OutApplicationEditView1_btnChooseEmployeeHidden").trigger("click");
}
    ...
    {   
       ...
       var selectType=$(".outType").val();
       $Lording.attr("src","../../../Pages/image/loading_js.gif").css("display","block");
       $.ajax({
       url:"../OutApplicationPages/CalculateOutApplication.aspx",
       cache: false,
       type:"get", 
       data: "FromDate="+$FromDate.val()+"&FromHour="+$FromHour.val()+"&FromMinute="+$FromMinute.val()+"&ToDate="+$ToDate.val()+"&ToHour="+$ToHour.val()+"&ToMinute="+$ToMinute.val()+"&AccountID="+$("#cphCenter_OutApplicationEditView1_hfEmployeeID").val()+"&OutType="+selectType,          
       success:function(data){  if(data=="error"){$Lording.attr("src","../../../Pages/image/wrong_icon.gif").css("display","block");$Answer.val("0");}
    ...
    function GetCountMonth()
    {
        ...
        $("#cphCenter_OutApplicationEditView1_lbDate").html(ReplaceCh(fromMax.toLocaleString())+" ～ "+ReplaceCh(toMax.toLocaleString()));
    }
    ...
    function AllCount()
    { 
     var count=0;   $(".answer").each(function(){count=Number(count)+Number($(this).val());});    $("#cphCenter_OutApplicationEditView1_lbCostTime").html(Number(count)+"小时");
    }
    ...
    function CountMonth(fot,maxormin)
    {
     ...
     function judgeTime()
     {
        ...
        if(!time)
        {$("#cphCenter_OutApplicationEditView1_divResultMessage").show(); 
        $("#cphCenter_OutApplicationEditView1_lbResultMessage").html("<span class='fontred'>时间格式错误</span>");}
        else {$("#cphCenter_OutApplicationEditView1_divResultMessage").hide();}
        return time;
     }
</script>
