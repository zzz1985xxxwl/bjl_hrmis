<%@ Control Language="C#" AutoEventWireup="true" Codebehind="CancelOutApplicationItemView.ascx.cs"
    Inherits="SEP.Performance.Views.HRMIS.OutApplications.CancelOutApplicationItemView" %>
            ...
            <table width="100%" border="0">
               ...
               <tr>
                    ...
                    <td align="left">
                        外出类型</td>
                    <td align="left">
                        <asp:DropDownList ID="ddlOutType" runat="server" Enabled="false">
                        </asp:DropDownList>
                      </td>
                    <td align="left">
                        外出时间</td>
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtOutLoacation" runat="server" CssClass="grayborder" ReadOnly="true"></asp:TextBox></td>
                    <td align="left">
                    </td>
                    <td align="left">
                     </td>
                ...
                <tr>
                    ...
                    <td align="left" colspan="3" valign="top">
                        <asp:TextBox runat="server" ID="tbReason" CssClass="grayborder" Enabled="false" Height="70px" TextMode="MultiLine"
