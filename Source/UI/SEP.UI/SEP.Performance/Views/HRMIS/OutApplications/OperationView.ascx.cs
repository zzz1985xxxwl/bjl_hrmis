...
{
    public partial class OperationView : UserControl, IOperationView
    {
        ...
        public string OutApplicationFlowID
        {
        ...
        {
            get { return Convert.ToInt32(tbOutApplicationID.Text.Trim()); }
            set { tbOutApplicationID.Text = value.ToString(); }
        }
