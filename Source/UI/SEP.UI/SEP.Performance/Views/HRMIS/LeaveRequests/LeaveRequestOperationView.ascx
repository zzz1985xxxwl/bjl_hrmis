<%@ Control Language="C#" AutoEventWireup="true" Codebehind="LeaveRequestOperationView.ascx.cs"
    Inherits="SEP.Performance.Views.HRMIS.LeaveRequests.LeaveRequestOperationView" %>
    ...
    <table width="100%" border="0">
        <tr>
            ...
            <td width="15%" align="left">
                请假单编号</td>
            <td align="left">
                <asp:TextBox ID="tbLeaveRequestID" runat="server" CssClass="input1" ReadOnly="True"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right">
