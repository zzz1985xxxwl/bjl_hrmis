...
{
    public partial class EmployeeSalaryHistoryDetailView : UserControl, IEmployeeSalaryHistoryDetailPresenter
    {
        ...
        public EmployeeSalary EmployeeSalary
        {
            set
            {
                ...
                if (value.EmployeeSalaryHistoryList != null && value.EmployeeSalaryHistoryList.Count > 0)
                {
                    AccountSet = value.EmployeeSalaryHistoryList[0].EmployeeAccountSet;
                }
            }
        }
    }
