<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SetEmployeeAccountDetailView.ascx.cs" Inherits="SEP.Performance.Views.HRMIS.PayModuleViews.SetEmployeeAccountDetailView" %>
