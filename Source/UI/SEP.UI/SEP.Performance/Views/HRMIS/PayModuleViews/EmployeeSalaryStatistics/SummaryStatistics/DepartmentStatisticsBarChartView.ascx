<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DepartmentStatisticsBarChartView.ascx.cs" Inherits="SEP.Performance.Views.HRMIS.PayModuleViews.EmployeeSalaryStatistics.SummaryStatistics.DepartmentStatisticsBarChartView" %>
<%@ Register Assembly="ZedGraph.Web" Namespace="ZedGraph.Web" TagPrefix="cc1" %>
<div id="divChart" runat="server">
<cc1:ZedGraphWeb ID="ZedGraphWeb1" runat="server" RenderedImagePath="~/pages/image/imageZedGraph/" Height="200" Width="750">
