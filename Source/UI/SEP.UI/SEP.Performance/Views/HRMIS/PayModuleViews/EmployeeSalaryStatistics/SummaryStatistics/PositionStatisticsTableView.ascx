<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PositionStatisticsTableView.ascx.cs" Inherits="SEP.Performance.Views.HRMIS.PayModuleViews.EmployeeSalaryStatistics.SummaryStatistics.PositionStatisticsTableView" %>
...
<asp:DataGrid ID="dgPositionStatisticsTable"  runat="server" CssClass="FixedGridViewTable" GridLines="None" Width="100%" 
 OnItemDataBound="dgPositionStatisticsTable_RowDataBound"> 
