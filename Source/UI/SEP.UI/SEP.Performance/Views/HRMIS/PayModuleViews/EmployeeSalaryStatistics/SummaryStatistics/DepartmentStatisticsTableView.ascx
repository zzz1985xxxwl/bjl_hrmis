<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DepartmentStatisticsTableView.ascx.cs" Inherits="SEP.Performance.Views.HRMIS.PayModuleViews.EmployeeSalaryStatistics.SummaryStatistics.DepartmentStatisticsTableView" %>

<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr id="trStatistics" runat="server">
    <td height="68"  style="width:100%;">
