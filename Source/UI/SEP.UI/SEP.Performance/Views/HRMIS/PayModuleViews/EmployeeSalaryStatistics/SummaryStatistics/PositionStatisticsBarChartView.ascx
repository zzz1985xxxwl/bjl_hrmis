<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PositionStatisticsBarChartView.ascx.cs" Inherits="SEP.Performance.Views.HRMIS.PayModuleViews.EmployeeSalaryStatistics.SummaryStatistics.PositionStatisticsBarChartView" %>
