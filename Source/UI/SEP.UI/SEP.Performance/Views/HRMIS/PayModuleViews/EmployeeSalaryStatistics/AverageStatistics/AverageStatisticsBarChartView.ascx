<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AverageStatisticsBarChartView.ascx.cs" Inherits="SEP.Performance.Views.HRMIS.PayModuleViews.EmployeeSalaryStatistics.AverageStatistics.AverageStatisticsBarChartView" %>
