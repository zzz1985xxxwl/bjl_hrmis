...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OverWorkSelfListView.ascx.cs"
    Inherits="SEP.Performance.Views.HRMIS.OverWorks.OverWorkSelfListView" %>
<%@ Register Src="../../PageTemplate.ascx" TagName="PageTemplate" TagPrefix="uc1" %>
<asp:HiddenField ID="hfCount" runat="server" Value="0" />
<div class="leftitbor2">
    <asp:Label ID="lbOperationType" runat="server">我的加班单</asp:Label>
    &nbsp; <a href="../../../Pages/HRMIS/OverWorkPages/AddOverWork.aspx">新增加班单</a>
</div>
<div class="marginepx">
    <asp:GridView ID="grd" runat="server" CssClass="linetable" GridLines="None" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="加班人员">
                <ItemTemplate>
