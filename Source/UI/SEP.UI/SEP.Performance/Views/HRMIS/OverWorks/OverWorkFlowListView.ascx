<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OverWorkFlowListView.ascx.cs" Inherits="SEP.Performance.Views.HRMIS.OverWorks.OverWorkFlowListView" %>
<%@ Register Src="../../PageTemplate.ascx" TagName="PageTemplate" TagPrefix="uc1" %>
        <asp:GridView ID="grd" runat="server" AllowPaging="True" AutoGenerateColumns="False"   CssClass="linetable" 
