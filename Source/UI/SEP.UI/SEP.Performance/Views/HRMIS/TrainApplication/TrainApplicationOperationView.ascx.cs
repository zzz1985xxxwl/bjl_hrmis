...
{
    public partial class TrainApplicationOperationView : UserControl, ITrainApplicationOperatorView
    {
        ...
        public string ApplicationFlowID
        {
            get
            {
