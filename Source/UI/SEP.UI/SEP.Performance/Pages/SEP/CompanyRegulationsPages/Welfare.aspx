<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="../MasterPage.Master" CodeBehind="Welfare.aspx.cs" Inherits="SEP.Performance.Pages.SEP.CompanyRegulationsPages.Welfare" %>
...
<asp:Content ID="WelfareContent" runat="server" ContentPlaceHolderID="cphCenter">
<div class="rule">
