...
{
    public partial class FeedBackPaperUpdate : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            FeedBackPaperUpdatePresenter presenter = new FeedBackPaperUpdatePresenter(Convert.ToInt32(SecurityUtil.DECDecrypt(Request.QueryString["PaperID"])), FeedBackPaperView1, LoginUser);
