...
{
    public partial class FeedBackPaperDetail : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            FeedBackPaperDetailPresenter presenter = new FeedBackPaperDetailPresenter(Convert.ToInt32(SecurityUtil.DECDecrypt(Request.QueryString["PaperID"])), FeedBackPaperView1, LoginUser);
