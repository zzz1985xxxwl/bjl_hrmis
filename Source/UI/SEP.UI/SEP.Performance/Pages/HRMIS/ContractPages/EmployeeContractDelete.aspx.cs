...
{
    public partial class EmployeeContractDelete : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            EmployeeContractDeletePresenter presenter = new EmployeeContractDeletePresenter(EmployeeContractView1);
            EmployeeContractView1.btnOKClick += presenter.DeleteContractEvent;
            EmployeeContractView1.btnCancelClick += presenter.CancleEvent;
            presenter.ToContractListPage += ToContractListPage;
            presenter.InitView(SecurityUtil.DECDecrypt(Request.QueryString[ConstParameters.EmployeeId]),SecurityUtil.DECDecrypt(Request.QueryString[ConstParameters.ContractId]), Page.IsPostBack);
        }
