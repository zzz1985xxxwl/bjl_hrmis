...
{
    public partial class EmployeeContractDetail : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            EmployeeContractDetailPresenter presenter = new EmployeeContractDetailPresenter(EmployeeContractView1);
            EmployeeContractView1.btnOKClick += presenter.DetailContractEvent;
            EmployeeContractView1.btnCancelClick += presenter.CancleEvent;
            presenter.ToContractListPage += ToContractListPage;
            presenter.InitView(SecurityUtil.DECDecrypt(Request.QueryString[ConstParameters.ContractId]), Page.IsPostBack);
        }
