...
{
    [TestFixture]
    public class AutoRemindProbationDateRearchTest
    {
        ...
        private AutoRemindProbationDateRearch _Target;
        ...
        public void AutoEmployeeResidenceDateRearchTest1()
        {
            ...
            employee1.EmployeeDetails.ProbationTime = new DateTime(2008, 9, 29);
            ...
            employee2.EmployeeDetails.ProbationTime = new DateTime(2008, 9, 30);
            Employee employee3 =
            ...
            employee3.EmployeeDetails.ProbationTime = new DateTime(2008, 9, 28);
            employeeList.Add(employee1);
            employeeList.Add(employee2);
            employeeList.Add(employee3);
            //GetEmployeeByBasicCondition相关
            List<Account> accountList = new List<Account>();
            accountList.Add(employee1.Account);
            accountList.Add(employee2.Account);
            accountList.Add(employee3.Account);
            Expect.Call(_IAccountBll.GetAccountByBaseCondition("", -1, -1, false, null)).Return(accountList);
            ...
            Assert.AreEqual(_Target.MailBodyListToHR[0].Subject, "员工试用期即将到期");
            Assert.AreEqual(_Target.MailBodyListToHR[0].Body, "以下员工试用期将在60天后到期\r\n王莎莉");
        }
        [Test, Description("系统跟踪自发提醒试用期到期,给人事，发信失败")]
        ...
        [Test, Description("系统跟踪自发提醒试用期到期,给人事,如果离职则不提醒")]
    ...
    new Employee(new Account(4, "", "你好"), "ni.hao@staples.sh.cn", "",
            ...
            employee4.EmployeeDetails.ProbationTime = new DateTime(2008, 9, 29);
            ...
            accountList.Add(employee2.Account);
            accountList.Add(employee3.Account);
            accountList.Add(employee4.Account);
            Expect.Call(_IAccountBll.GetAccountByBaseCondition("", -1, -1, false, null)).Return(accountList);
            //GetEmployeeByAccountID相关
            Expect.Call(_IEmployee.GetEmployeeByAccountID(employee1.Account.Id)).Return(employee1);
            Expect.Call(_IAccountBll.GetAccountById(employee1.Account.Id)).Return(employee1.Account);
            ...
            Expect.Call(_IDepartmentBll.GetDepartmentById(employee3.Account.Dept.Id, null)).Return(
                employee3.Account.Dept);
            Expect.Call(_IEmployee.GetEmployeeByAccountID(employee4.Account.Id)).Return(employee4);
        ...
        [Test, Description("系统跟踪自发提醒试用期到期,给人事,如果借用则不提醒")]
    ...
    new Employee(new Account(4, "", "你好"), "ni.hao@staples.sh.cn", "",
        ...
        [Test, Description("系统跟踪自发提醒试用期到期,离职员工无需发起")]
        ...
        [Test, Description("系统跟踪自发提醒试用期到期,借用员工无需发起")]
