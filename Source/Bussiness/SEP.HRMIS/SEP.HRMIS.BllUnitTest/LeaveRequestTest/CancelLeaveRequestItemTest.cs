...
{
    [TestFixture]
    public class CancelLeaveRequestItemTest
    {
        

        [Test, Ignore, Description("成功取消一个请假项")]
        public void CancelLeaveRequestItemSuccess()
        {
            ...
            CancelLeaveRequestItem Target =
                new CancelLeaveRequestItem(1, 1, 1, RequestStatus.Approving, "", iLeaveRequestDal, iLeaveRequestFlowDal,
        ...
        [Test, Ignore, Description("该请假单部分不能被取消")]
        public void LeaveRequestPartialCanNotBeCancled()
        {
            MockRepository mocks = new MockRepository();
            ILeaveRequestDal iLeaveRequestDal = mocks.CreateMock<ILeaveRequestDal>();
            ILeaveRequestFlowDal iLeaveRequestFlowDal = mocks.Stub<ILeaveRequestFlowDal>();
            ...
            {
                Assert.AreEqual("该请假单部分不能被取消", ex.Message);
            }
            mocks.VerifyAll();
        }
    }
