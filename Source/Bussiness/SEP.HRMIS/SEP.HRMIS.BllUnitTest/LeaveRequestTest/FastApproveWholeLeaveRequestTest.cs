...
{
    [TestFixture]
    public class FastApproveWholeLeaveRequestTest
    {
        

        [Test, Description("成功快速审核整张请假单")]
        public void ApproveFailLeaveRequestItemSuccess()
        {
            ...
            FastApproveWholeLeaveRequest Target =
                new FastApproveWholeLeaveRequest(1, 1, "", iLeaveRequestDal, iLeaveRequestFlowDal,
                                                 iEmployeeDiyProcessDal, iVacation,
                                                 iAdjustRest, iPlanDutyDal, iLeaveRequestType);
            Target.Excute();
            mocks.VerifyAll();
        }
