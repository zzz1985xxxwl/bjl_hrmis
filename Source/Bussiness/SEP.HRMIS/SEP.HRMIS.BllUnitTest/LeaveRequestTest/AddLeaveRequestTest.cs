...
{
    [TestFixture]
    public class AddLeaveRequestTest
    {
        //todo yyb 判断如果请的是年假，请假时间是否超过他的剩余年假天数
        //todo yyb 判断如果请的是调休，请假时间是否超过他的剩余调休
        
        [Test, Description("成功新增请假")]
        public void AddLeaveTypeTestSuccessfull()
        {
            ...
            Expect.Call(
                iLeaveRequestDal.CountLeaveRequestInRepeatDateDiffPKID(1, 0, Convert.ToDateTime("2009-1-1"),
                                                                       Convert.ToDateTime("2009-1-1"))).Return(0);
            Expect.Call(
                iLeaveRequestDal.CountLeaveRequestInRepeatDateDiffPKID(1, 0, Convert.ToDateTime("2009-1-2"),
            ...
            Expect.Call(
                iLeaveRequestDal.InsertLeaveRequest(leaveRequest, 1)).Return(1);
            ...
            AddLeaveRequest Target =
                new AddLeaveRequest(leaveRequest, ifSubmit, iVacation, iAdjustRest, iLeaveRequestDal,
