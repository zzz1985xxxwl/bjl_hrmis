...
{
    public class InterruptEmployeeReimburses : Transaction
    {
        /// <summary>
        /// 构造类工厂
        /// </summary>
        ...
        public InterruptEmployeeReimburses(int employeeID, List<HRMISModel.Reimburse> reimburseID, Employee _operator)
        {
            _ReimburseID = reimburseID;
            _EmployeeID = employeeID;
            _Operator = _operator;
        }
        public InterruptEmployeeReimburses(int employeeID, List<HRMISModel.Reimburse> reimburseID, Employee _operator, IReimburse dalReimburse)
        {
            _ReimburseID = reimburseID;
            _EmployeeID = employeeID;
            _Operator = _operator;
        ...
        protected override void ExcuteSelf()
        {
            try
            {
                ...
                for (int i = 0; i < _ReimburseID.Count; i++)
                {
                    ...
                    reimburseToUpdate.ReimburseStatus = ReimburseStatusEnum.Return;
