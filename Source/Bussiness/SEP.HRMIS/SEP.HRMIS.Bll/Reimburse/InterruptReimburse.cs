...
{
    public class InterruptReimburse : Transaction
    {
        /// <summary>
        /// 构造类工厂
        /// </summary>
        ...
        public InterruptReimburse(int employeeID, int reimburseID, Employee _operator)
        {
        ...
        public InterruptReimburse(int employeeID, int reimburseID, Employee _operator, IReimburse iReimburseMock)
        {
        ...
        protected override void ExcuteSelf()
        {
            try
            {
                using (TransactionScope ts = new TransactionScope(TransactionScopeOption.Required))
                {
                    ...
                    reimburse.ReimburseStatus = ReimburseStatusEnum.Return;
