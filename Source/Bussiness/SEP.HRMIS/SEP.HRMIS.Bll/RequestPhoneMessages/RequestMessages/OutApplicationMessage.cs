...
// All rights reserved.
// FileName: OutApplicationMessage.cs
// Creater:  Xue.wenlong
// Date:  2009-05-31
// Resume:
// ---------------------------------------------------------------
...
namespace SEP.HRMIS.Bll.RequestPhoneMessages.RequestMessages
{
    ...
    /// 
    /// </summary>
    public class OutApplicationMessage : RequestMessageBase
    {
        private static readonly string _Template = "外出或wc 起始时间 结束时间  地点 原因";
        private static readonly string _Example = "外出 200809160900 200809161730  某地 某事";
        ...
        public OutApplicationMessage(Account employee, ReceiveMessageDataModel message)
        ...
        private OutApplication BuildOutApplication
        {
            get
            {
                ...
                OutApplication outapplication =
                    new OutApplication(0, _Account, DateTime.Now, _Reason, _From, _To, _CostTime, items, _Place, OutType.InCity);
