...
{
    public class ForeignTaxFunction
    {
        private readonly IndividualIncomeTax _IndividualIncomeTax;
        public ForeignTaxFunction(IndividualIncomeTax individualIncomeTax)
        {
        ...
        public object doFunction(object beforetax)
        {
            ...
            //如果税前工资小于起征点
            if(_BeforeTax <=(double)_IndividualIncomeTax.ForeignTaxCutoffPoint)
            {
                return 0;
            }
            //排序
            ...
            double margin = _BeforeTax - (double) _IndividualIncomeTax.ForeignTaxCutoffPoint;
